function trackingError = vehicleevaluateTracker(params, junc, initTime, runFrameNum)
    % 数据路径
    ...
    tracker = trackerJPDA(...
        ...
        AssignmentThreshold=[params.AssignThresh1, params.AssignThresh2], ...
        MaxNumTracks=500, ...
    ...
    for frame = 1:numFrames
        ...
        % 合并检测结果
        if frame == 1
            detections = vehiclelidarDetections;
        else
            detections = [vehiclelidarDetections; vehiclecameraDetections];
        end
