...
Finally, the images are reshaped to a size of 224\(\times\)224.
...
The cameras have a resolution of 1920\(\times\)1080 pixels and a field of view of 90 degrees, ensuring the capture of wide-angle image data in high definition. 
...
\begin{figure}[t]
	...
	\caption{Analysis of the impact of point cloud detection threshold on multi-target tracking performance. Experiments show that the accuracy and threshold of vehicle detection are the key factors affecting multi-object tracking performance.} 
	\label{fig:6} 
\end{figure}
