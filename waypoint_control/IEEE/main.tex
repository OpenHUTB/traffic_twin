...
During the LiDAR detection process, we set a threshold for the detection results. Targets exceeding the threshold are identified as vehicles, and targets below the threshold are excluded as other objects.
