...
\begin{IEEEkeywords}
digital twins, automated driving, vehicle detection, multi-object tracking, trajectory restoration.
\end{IEEEkeywords}
...
First, the object-level fusion detection method based on cameras and radars is used to improve vehicle detection accuracy and thus enhance tracking robustness. 
