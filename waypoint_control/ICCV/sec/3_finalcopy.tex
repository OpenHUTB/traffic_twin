...
We utilize Carla to conduct twin experiments, leveraging its highly realistic virtual environment, flexible sensor configurations, and diverse traffic scenarios, which efficiently simulate complex real-world driving conditions. 
